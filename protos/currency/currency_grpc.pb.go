...
type CurrencyClient interface {
	...
	GetRate(ctx context.Context, in *RateReq, opts ...grpc.CallOption) (*RateRes, error)
}
...
func (c *currencyClient) GetRate(ctx context.Context, in *RateReq, opts ...grpc.CallOption) (*RateRes, error) {
	out := new(RateRes)
...
type CurrencyServer interface {
	// GetRate() is a method that returns an number which can be used to convert from one type to another
	GetRate(context.Context, *RateReq) (*RateRes, error)
...
func (UnimplementedCurrencyServer) GetRate(context.Context, *RateReq) (*RateRes, error) {
...
func _Currency_GetRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CurrencyServer).GetRate(ctx, req.(*RateReq))
	}
